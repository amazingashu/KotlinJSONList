...
class CustomAdapter(private val context: Context, private val playersModelArrayList: ArrayList<Players_Model>) :
    BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.listitems, null, true)
